...
public interface UserMapper extends BaseMapper<User> {
    ...
    List<String> getAccountByRoleId(String userName);

    List<Map> selectUserIdByMenuId(@Param("menuId")String menuId);

    @Delete("delete from oauth_user_info where user_id = #{userId}")
    void removeOauth(Long userId);
