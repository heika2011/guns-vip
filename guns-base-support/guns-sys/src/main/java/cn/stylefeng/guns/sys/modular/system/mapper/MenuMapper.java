...
public interface MenuMapper extends BaseMapper<Menu> {
     ...
     */
    List<MenuNode> getMenusByRoleIds(@Param("roleIds")List<Long> roleIds,@Param("type")String type);
     ...
     * @return
     */
    List<MenuNode> getOutMenusByRoleIds(@Param("roleList")List<Long> roleList);

    /**
     * 获取前端接口
     * @return
     */
    List<MenuNode> getOutMenus();
}
