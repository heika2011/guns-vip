...
public class MenuService extends ServiceImpl<MenuMapper, Menu> {
     ...
     */
    public List<MenuNode> getMenusByRoleIds(List<Long> roleIds,String type) {
        List<MenuNode> menus = this.baseMapper.getMenusByRoleIds(roleIds,type);
    ...
    public List<MenuNode> getOutMenusByRoleIds(List<Long> roleList) {
        List<MenuNode> menuNodes = this.baseMapper.getOutMenusByRoleIds(roleList);
        return menuNodes;
    }

    public List<MenuNode> getOutMenusByRoleIds() {
        List<MenuNode> menuNodes = this.baseMapper.getOutMenus();
        return menuNodes;
    }
}
