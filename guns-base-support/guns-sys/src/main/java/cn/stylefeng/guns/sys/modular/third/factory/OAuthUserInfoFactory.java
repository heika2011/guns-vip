...
public class OAuthUserInfoFactory {
    ...
    public static User createOAuthUser(AuthUser authUser) {
        ...
        String password = SaltUtil.md5Encrypt(String.valueOf(ConstantsContext.getDefaultPassword()), salt);
        systemUser.setPassword(password);
        systemUser.setSalt(salt);

        //利用openId设置账号
        systemUser.setAccount(ConstantsContext.getOAuth2UserPrefix()  + "_" + authUser.getUsername());
