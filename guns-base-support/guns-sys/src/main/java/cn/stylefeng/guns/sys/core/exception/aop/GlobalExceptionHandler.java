...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public JSONResult unAuth(AuthException e) {
        return new JSONResult(e.getCode().toString(), e.getMessage());
    }
    ...
    @ResponseStatus(HttpStatus.UNAUTHORIZED)
    @ResponseBody
    public JSONResult permissionExpection(PermissionException e) {
        return new JSONResult("-1","没有权限访问");
    }
